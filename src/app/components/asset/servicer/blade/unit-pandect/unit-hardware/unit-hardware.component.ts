...
import { UnitHardwareService } from "./unit-hardware.service";

@Component({
    selector: 'app-unit-hardware',
    templateUrl: './unit-hardware.component.html',
    styleUrls: ['./unit-hardware.component.scss'],
    providers: [ UnitHardwareService ]
})

export class UnitHardwareComponent implements OnInit {
    serverId: string;
    productColumn = [
    ...
    powerInfo = [];
    constructor(
        private $service: UnitHardwareService,
