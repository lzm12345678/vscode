...
import { UnitOperParamService } from "./unit-oper-param.service";
import { Router, ActivatedRoute } from '@angular/router'
import { MissionService } from "../../../../../../mission-store/mission.service";

@Component({
    selector: 'app-unit-oper-param',
    templateUrl: './unit-oper-param.component.html',
    styleUrls: ['./unit-oper-param.component.scss'],
    providers: [ UnitOperParamService ]
})

export class UnitOperParamComponent implements OnInit {
    ...
    constructor(
        private $service: UnitOperParamService,
